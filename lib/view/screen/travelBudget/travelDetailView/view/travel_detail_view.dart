...
import 'package:trackexpense/view/screen/travelBudget/addTravelMate/view/add_travelmate_view.dart';
...
class _TravelDetailViewState extends State<TravelDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<TravelDetailBloc, TravelMateDataBlocState>(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: SizedBox(
                        ...
                        child: Center(
                            child: Text(
                          widget.travelModel.place ?? 'Travel Budget',
                          style: TextStyle(
                              color: kWhite,
